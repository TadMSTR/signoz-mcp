...
- **GitHub private disclosure:** Use the [Security tab](https://github.com/TadMSTR/signoz-mcp/security/advisories/new) to submit a private advisory.
- **Email:** Send a description to `security.i9v75@8alias.com` with the subject line `[signoz-mcp] Security Report`.
...
- SSRF via the SigNoz endpoint configuration
- Injection in trace, metric, or log query parameters passed to the SigNoz API
- Information disclosure through observability data containing sensitive service details or credentials
- Dependency vulnerabilities with a plausible exploitation path in signoz-mcp's usage
